...
- **Status:** 53/58 done (FeaturedIcon added). Phases 1–4 COMPLETE — Phase 4 (Overlays) finished with all 13 overlays (Tooltip…Toast). Phase 5 (final): ModeToggler, Direction, Sidebar, Chat. Next up: **ModeToggler**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **ModeToggler**).
