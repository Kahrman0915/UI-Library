...
- **Status:** 50/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip through Select shipped (10 overlays). Next up: **Combobox**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **Combobox**).
