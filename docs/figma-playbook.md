...
- **Status:** 49/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip, Dialog, AlertDialog, Drawer, Popover, HoverCard, DropdownMenu, ContextMenu, Menubar shipped. Next up: **Select**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **Select**).
