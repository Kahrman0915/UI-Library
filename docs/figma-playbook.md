...
- **Status:** 43/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip, Dialog, AlertDialog shipped. Next up: **Drawer**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **Drawer**).
