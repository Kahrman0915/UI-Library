...
- **Status:** 51/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip through Combobox shipped (11 overlays). Next up: **Command**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **Command**).
