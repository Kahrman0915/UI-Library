...
- **Status:** 46/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip, Dialog, AlertDialog, Drawer, Popover, HoverCard shipped. Next up: **DropdownMenu**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **DropdownMenu**).
