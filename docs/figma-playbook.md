...
- **Status:** 42/58 done (FeaturedIcon added). Phases 1–3 COMPLETE; Phase 4 (Overlays) under way — Tooltip, Dialog shipped. Next up: **AlertDialog**. Queue in the ledger.
...
1. Read the ledger → next component in the phase queue (next up: **AlertDialog**).
